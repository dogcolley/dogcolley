...
<section id="bo_w">
    ...
    <div class="tbl_frm01 tbl_wrap">
        ...
        <?php if ($is_category) { ?>
        <tr>
            <th scope="row"><label for="ca_name">지점<strong class="sound_only">필수</strong></label></th>
            <td>
		...
		<tr>ㅇㅇㅇ
            <th scope="row"><label for="wr_1">수술선택<strong class="sound_only">필수</strong></label></th>
            <td>
                <select class="form-control input02 required" id="wr_1" name="wr_1" required>
                    <option value="">선택하세요</option>
                    <option value="맞춤형수술" <?php echo ( $write['wr_1'] == "맞춤형수술" ) ? "selected" : "";?>>맞춤형수술</option>
					<option value="귀두확대" <?php echo ( $write['wr_1'] == "귀두확대" ) ? "selected" : "";?>>귀두확대</option>
					<option value="몸통확대" <?php echo ( $write['wr_1'] == "몸통확대" ) ? "selected" : "";?>>몸통확대</option>
					<option value="길이연장" <?php echo ( $write['wr_1'] == "길이연장" ) ? "selected" : "";?>>길이연장</option>
					<option value="조루수술" <?php echo ( $write['wr_1'] == "조루수술" ) ? "selected" : "";?>>조루수술</option>
					<option value="발기부전" <?php echo ( $write['wr_1'] == "발기부전" ) ? "selected" : "";?>>발기부전</option>
					<option value="보형물" <?php echo ( $write['wr_1'] == "보형물" ) ? "selected" : "";?>>보형물</option>		
					<option value="무도정관수술" <?php echo ( $write['wr_1'] == "무도정관수술" ) ? "selected" : "";?>>무도정관수술</option>
					<option value="레이저포경수술" <?php echo ( $write['wr_1'] == "레이저포경수술" ) ? "selected" : "";?>>레이저포경수술</option>
					<option value="이물질제거" <?php echo ( $write['wr_1'] == "이물질제거" ) ? "selected" : "";?>>이물질제거</option>
					<option value="음경만곡증" <?php echo ( $write['wr_1'] == "음경만곡증" ) ? "selected" : "";?>>음경만곡증</option>
					<option value="인공고환" <?php echo ( $write['wr_1'] == "인공고환" ) ? "selected" : "";?>>인공고환</option>
					<option value="울트라스템" <?php echo ( $write['wr_1'] == "울트라스템" ) ? "selected" : "";?>>울트라스템</option>
                </select>
            </td>
        </tr>
        ...
        <tr>
            ...
            <td><input type="text" name="wr_3" value="<?php echo $wr_3 ?>" id="wr_3" required class="frm_input required" maxlength="20"></td>
        </tr>
        <?php } ?>
