...
<section id="bo_w">
    ...
    <div class="tbl_frm01 tbl_wrap">
        ...
        <tr>
            ...
            <td><input type="text" name="wr_area" style="width:200px;" value="<?php echo $write['wr_area'] ?>" id="wr_area" required class="frm_input required" placeholder="숫자만입력하세요"></td>
        </tr>
        ...
        <tr>
            ...
            <td><input type="text" name="wr_min" style="width:122px;" value="<?php echo $write['wr_min'] ?>" id="wr_min" class="frm_input" placeholder="숫자만입력하세요"> / 
            <input type="text" name="wr_max" style="width:122px;" value="<?php echo $write['wr_max'] ?>" id="wr_max" class="frm_input" placeholder="숫자만입력하세요"></td>
        </tr>
        <tr>
            ...
            <td>
                <table>
                    ...
                    <tr>
                        ...
                        <td><input type="text" value="<?php echo $write['wr_11']?>" name="wr_11" id="wr_11" class="frm_input"></td>
                        <td><input type="text" value="<?php echo $write['wr_12']?>" name="wr_12" id="wr_12" class="frm_input"></td>
                        <td><input type="text" value="<?php echo $write['wr_13']?>" name="wr_13" id="wr_13" class="frm_input"></td>
                    </tr>
                ...
                <table>
                    ...
                    <tr>
                        ...
                        <td><input type="hidden" name="date_name" value="비수기">
                            <input type="text" value="<?php echo $write['wr_weekday비수기']?>" name="wr_weekday비수기" class="frm_input" style="width: 100%"></td>
                        <td><input type="text" value="<?php echo $write['wr_weekend비수기']?>" name="wr_weekend비수기" class="frm_input" style="width: 100%"></td>
                        <?php if ($board['bo_7_subj']): ?>
                            <td><input type="text" value="<?php echo $write['wr_weekend2비수기']?>" name="wr_weekend2비수기" class="frm_input" style="width: 100%"></td>
                        <?php endif ?>
                    </tr>
                    <?php
                    for ($i=0; $i < count($date_config); $i++) { 
                    ...
                    ?>
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                <input type="text" value="<?php echo $write[$day_name]?>" name="wr_weekday<?=$date_config[$i]['date_name'];?>" class="frm_input" style="width: 100%">
                            </td>
                            <td>
                                <input type="text" value="<?php echo $write[$end_name]?>" name="wr_weekend<?=$date_config[$i]['date_name'];?>" class="frm_input" style="width: 100%">
                            </td>
                            <?php if ($board['bo_7_subj']): ?>
                                <td>
                                    <input type="text" value="<?php echo $write[$end2_name]?>" name="wr_weekend2<?=$date_config[$i]['date_name'];?>" class="frm_input" style="width: 100%">
                                </td>
                            <?php endif ?>
                        </tr>
                    <?php }?>
        ...
        <tr>
            ...
            <td id = "sale_maker">
                ...
                <?if ($write['wr_roomsale']) {?>
                    ...
                    2박 예약시 <input type='text' name='wr_roomsale1' value='<?php echo $write['wr_roomsale1'] ?>' id='wr_roomsale1' class='frm_input' style="width: 94px;"> 원 할인<br>
                    3박 예약시 <input type='text' name='wr_roomsale2' value='<?php echo $write['wr_roomsale2'] ?>' id='wr_roomsale2' class='frm_input' style="width: 94px;"> 원 할인<br>
                    4박이상 예약시 <input type='text' name='wr_roomsale3' value='<?php echo $write['wr_roomsale3'] ?>' id='wr_roomsale' class='frm_input' style="width: 94px;"> 원 할인
                <?}else{
            ...
            <td id = wr_add_option>
                ...
                for ($i=0; $i < count($option_array); $i++) { ?>
                    <tr class="col_option">
                        ...
                        <td><input type='text' style="width: 87px;" class='frm_input ops_class_price' name="wr_option_price<?=$i?>" value="<?= $write['wr_option_price'.$i]?>" ><input type="button" style="width: 10%;" value="X" name='remove_op'></td>
...
$(document).ready(function() { 
    ...
    $('[name=booking_choise]').click(function() {
        ...
        $.ajax( {
                url: "<?=$board_skin_url?>/ajax/ajax_import_booking.php?ver=20201008",
                type: "POST",
                data: {
                    "bo_table" : "<?=$bo_table?>",
                    "id" : id
    ...
    $("#wr_roomsale").change(function(){
        if ($("#wr_roomsale").is(":checked")) {
            ...
            document.getElementById("sale_maker").innerHTML = "2박 예약시 <input type='text' name='wr_roomsale1' value='<?php echo $write['wr_roomsale1'] ?>' id='wr_roomsale1' class='frm_input' style='width: 94px;'> 원 할인<br>3박 예약시 <input type='text' name='wr_roomsale2' value='<?php echo $write['wr_roomsale2'] ?>' id='wr_roomsale2' class='frm_input' style='width: 94px;'> 원 할인<br>4박이상 예약시 <input type='text' name='wr_roomsale3' value='<?php echo $write['wr_roomsale3'] ?>' id='wr_roomsale' class='frm_input' style='width: 94px;'> 원 할인";
        }else{
    ...
    function addOption(){
        ...
        var txt = "<tr class='col_option'><td style='width: 10%;padding: 0;'>옵션명</td><td><input type='text' class='frm_input' name='wr_option_name"+count+"' style='width: 100%'></td><td style='width: 10%;padding: 0;'>가격</td><td><input type='text' class='frm_input' name='wr_option_price"+count+"' style='width: 87px;'><input type='button' style='width: 10%;' value='X' name='remove_op'></td></tr>";
