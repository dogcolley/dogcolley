...
// $sql = "SELECT * FROM {$g5['meta_table']} WHERE mta_db_table = 'board/{$_POST['bo_table']}'AND mta_db_id = '{$_POST['id']}' AND mta_key LIKE '%wr_option_price%'";
// $result = sql_query($sql);
// while ($row = sql_fetch_array($result)) {
// 	$price[] = $row['mta_value'];
// }
