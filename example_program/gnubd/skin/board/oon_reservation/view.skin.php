                        ...
                        <div class="price_data" style="margin-bottom:30px">
                            ...
                            <table class="info_table">
                                <body>
                                    ...
                                    <tr>
                                        <td>취소완료 날짜 : </td>
                                        <td><?php echo $view['wr_date_state_cancel'] ? $view['wr_date_state_cancel']  : '취소완료기록없음';?></td>
                                    </tr>
                                </body>
                            </table>
                        </div>
...
<script type="text/javascript" src="<?=$board_skin_url?>/js/view.js?ver=20200918"></script>
<script>
