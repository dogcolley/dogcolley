...
<form name="fwrite" id="fwrite" action="<?php echo $action_url ?>" onsubmit="return fwrite_submit(this);" method="post" enctype="multipart/form-data" autocomplete="off">
    ...
    <p style="margin-bottom:20px;border:1px solid #d9d9d9;padding:20px 30px">
        01.객실을 선택해주세요.<br/>
        02.입실날짜와 퇴실 날짜를 확인해주세요. <br/>
        03.인원수를 확인하여 주세요. </br>
        04.확인 완료 되었다면 완료를 눌러주세요.
    </p>
    ...
    <div class="multi-reserve-wrap <?=$z?>" data-wrid="<?=$booking_tb['wr_id']?>">
        <div class="info multi-reserve-tab">
            <div class="multi-reserve-tab-child clear">
                <h4 class="room-name" style="float: left;"> <label><?=$booking_tb['wr_subject']?></label></h4>
                <h4 class="room-name check-submit" style="display: none;">
                    <i class="fas fa-check" style="float: right;margin-right: 8px; font-size: 20px; "></i>
                </h4>
                <h4 class="room-name check-submit2" >
                    <span>객실을 선택하여 주세요.</span>
                    <i class="far fa-square" style="float: right;margin-right: 8px; font-size: 20px;"></i>
                    <i class="far fa-check-square"  style="float: right;margin-right: 8px; font-size: 20px;"></i>
                </h4>
            </div>
        </div>
            ...
            <tr>
                <td colspan="2">
                    <div style="text-align: center;">
                        <input type="button" value="객실 선택 완료" class="submit-btn-reserve">
                    </div>
                </td>
            </tr>
                </tbody>
...
<script type="text/javascript" src="<?=$board_skin_url?>/js/write.js?ver=20200918"></script>