	            		...
	            		<div class="wrap-sel-div">
							...
							<div class="sel sel--black-panther" style="float: right;">
							  <select id="wr_add1" class="chang_price">
							    <option value="" disabled><?=$board['bo_2_subj'] == '1' ? '성인' : '인원' ?></option>
					...
					<form action="./write.php?bo_table=<?=$board['bo_1']?>" method="post" class="list_form">
	            		...
	            		<li style="padding: 7px;" id="<?=$total_list[$i]['wr_id']?>" class="list_li">
		                	...
		                	<div class="li_list_obj">
		                		...
		                		<div>		
		                			<div class="booking_content" style="height: 128px;float: none;overflow-y:auto;">
...
','<br>',$remove_img)?></div>
		                		...
		                		<div class="price_cul">
		                			...
		                			<div style="overflow: hidden;">
		                				...
		                				<div class="price_subj_clas">추가인원 <i class="fas fa-question-circle" data-toggle="tooltip" title="<?=$board['bo_2_subj'] ? $text : str_replace('성인',' ',$text) ?>" data-html="true"></i></div><div class="add_prc">+0원</div>
		                			</div>
