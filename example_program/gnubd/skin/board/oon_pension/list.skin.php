...
//자동예약취소
include_once($board_skin_path."/searching_reservation/timeOutCancel.php");
...
if ($_GET['route']=="reserve_set") {
	...
	add_stylesheet('<link rel="stylesheet" href="'.$board_skin_url.'/css/pension.css?ver=20200918">', 0);
