            ...
            <td>
                <table>
                    <thead>
                        ...
                        <th scope="row" class="add_price">평일(월~목)</th>
                    ...
                    <tr>
                        ...
                        <td><input type="text" value="<?php echo $write['wr_weekend2비수기'] ? $write['wr_weekend2비수기'] : $write['wr_weekend비수기']?>" name="wr_weekend2비수기" class="frm_input only-number" style="width: 100%"></td>
                        <td><input type="text" value="<?php echo $write['wr_weekend3비수기'] ? $write['wr_weekend3비수기'] : $write['wr_weekend비수기']?>" name="wr_weekend3비수기" class="frm_input only-number" style="width: 100%"></td>
                    </tr>
                    <?php
                    for ($i=0; $i < count($date_config); $i++) { 
                    ...
                    ?>
                        ...
                        <tr>
                            ...
                            <td>
                                <input type="text" value="<?php echo $write[$end2_name] ? $write[$end2_name] : $write[$end_name] ?>" name="wr_weekend2<?=$date_config[$i]['date_name'];?>" class="frm_input only-number" style="width: 100%">
                            </td>
                            <td>
                                <input type="text" value="<?php echo $write[$end3_name] ? $write[$end3_name] : $write[$end_name] ?>" name="wr_weekend3<?=$date_config[$i]['date_name'];?>" class="frm_input only-number" style="width: 100%">
                            </td>
                        </tr>
                    <?php }?>
                    </tr>
