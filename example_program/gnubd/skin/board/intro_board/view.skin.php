...
<article id="bo_v" style="width:<?php echo $width; ?>">
    ...
    <section id="bo_v_atc">
        ...
        <div id="bo_v_con">
            <table>
                <tr>
                    <th>성명</th><td><?=$view['wr_subject']?></td>
                </tr>
                <tr>
                    <th>직업</th><td><?=$view['wr_2']?></td>
                </tr>
                <tr>
                    <th>직급</th><td><?=$view['wr_4']?></td>
                </tr>
                <tr>
                    <th>간단소개(외부노출)</th><td><?=nl2br($view['wr_3'])?></td>
                </tr>
                <tr>
                    <th>인사말</th><td><?=get_view_thumbnail($view['wr_1']);?></td>
                </tr><br>
                <tr>
                    <th>내용</th><td><?=get_view_thumbnail($view['content']);?></td>
                </tr>
