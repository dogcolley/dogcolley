...
<section id="bo_w">
    ...
    <div class="tbl_frm01 tbl_wrap">
        ...
        <tr>
            <th scope="row"><label for="wr_good">노출순서<strong class="sound_only">필수</strong></label></th>
            <td>
            <?php 
                if($wr_id)
                    $sort = sql_fetch("SELECT wr_good FROM ".$g5['write_prefix']."$bo_table WHERE wr_id = $wr_id");
                else 
                    $sort['wr_good'] = 0;
             ?>
            <input type="text" name="wr_good" value="<?php echo $sort['wr_good'] ?>" id="wr_good" required class="frm_input required"> 숫자가 적을수록 먼저 노출이 됩니다.</td>
        </tr>
        ...
        <?/*<tr>
            <th scope="row"><label for="wr_1">성명<strong class="sound_only">필수</strong></label></th>
            <td><input type="text" name="wr_1" value="<?php echo $write['wr_1'] ?>" id="wr_1" required class="frm_input required"></td>
        </tr>*/?>
        <tr>
            <th scope="row"><label for="wr_2">직업<strong class="sound_only">필수</strong></label></th>
            <td><input type="text" name="wr_2" value="<?php echo $write['wr_2'] ?>" id="wr_2" class="frm_input" style="width: 100%;"></td>
        </tr>
        <tr>
            <th scope="row"><label for="wr_4">직급<strong class="sound_only">필수</strong></label></th>
            <td><input type="text" name="wr_4" value="<?php echo $write['wr_4'] ?>" id="wr_4" class="frm_input" style="width: 100%;"></td>
        </tr>
        <tr>
            <th scope="row"><label for="wr_3">간단소개(외부노출)<strong class="sound_only">필수</strong></label></th>
            <td><textarea name="wr_3" id="wr_3" class="frm_input"><?php echo $write['wr_3'] ?></textarea></td>
        </tr>
        <tr>
            <th scope="row"><label for="wr_1">인사말</label></th>
