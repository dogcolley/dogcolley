...
<section id="bo_w">
    ...
    <div class="tbl_frm01 tbl_wrap">
        ...
        <tr>
            <th scope="row"><label for="wr_1">노출순서<strong class="sound_only">필수</strong></label></th>
            <td>
                <input type="text" name="wr_1" value="<?php echo $wr_1 ? $wr_1 : 0 ?>" id="wr_1" required class="frm_input required" maxlength="20">
                <br/> <p>순서가 높을수록 우선 노출 됩니다.</p>
            </td>
        </tr>
