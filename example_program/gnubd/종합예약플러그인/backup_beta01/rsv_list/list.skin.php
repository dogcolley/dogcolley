...
?>	
				<div class="U_month_rsv_list">
					<ul>
						...
						?>
						<li class="<?=$add_class?>"<?= $i!== 0 ?'style="border-top:1px dashed #d9d9d9;padding:5px;padding-top:0"' :'style="padding:5px;padding-top:0"'?>><?
								if($arr_ins_rsv[$i]['ch_status'] == '예약가능')
									echo '<a href="'.G5_BBS_URL.'/write.php?bo_table='.$bo_table.'&link_wr_id='.$arr_ins_rsv[$i]['wr_id'].'&set_day='.$set_day.'" style="padding:5px;padding-bottom:0">';
								else 
									echo '<a style="padding:5px;padding-bottom:0">';
								//echo '['.$arr_ins_rsv[$i]['ch_status'].'] ';
