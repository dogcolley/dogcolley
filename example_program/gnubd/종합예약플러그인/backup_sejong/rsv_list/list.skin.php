                            ...
                            <?
                                if(ch_limo($vDate) == 'false'){
                                    ...
                                    for($j=0;$j < count($arr_ins_rsv[$i]['ch_rsv_list']);$j++){
                                        ...
                                        echo $member['mb_level'] > 7 ? $arr_ins_rsv[$i]['ch_rsv_list'][$j]['wr_13']:  preg_replace('/.(?=.$)/u','*', $arr_ins_rsv[$i]['ch_rsv_list'][$j]['wr_13']);
                                        echo '</a>';
                                    }
                                }
							?></li>
...
?>
<div class="U_wrap02" style="display:none">
				...
				<td>
					<?
						...
						for($j=0;$j < count($booker);$j++){							
							...
							$set_txt = $member['mb_level'] > 7 ? $booker[$j]['wr_13'] :  preg_replace('/.(?=.$)/u','*',$booker[$j]['wr_13']);
							$color ='';
    ...
    <div class="tbl_head01 tbl_wrap">
        ...
        <tr>
            ...
            */?>
			...
			<th scope="col" class="M_ds_non" style="width:130px;">예약시간</th>
			...
			<th scope="col"style="width:130px;">생년월일</th>
        ...
        <tr class="J_list_base <?php if ($list[$i]['is_notice']) echo "bo_notice"; ?>">
			...
			<td class="td_date M_ds_non"><?php echo $item['wr_subject']?></td>
			<td style="text-align: center;">
				<a  href="<?php echo $list[$i]['href'] ?>">
				<?= $is_admin ? $list[$i]['wr_13']: preg_replace('/.(?=.$)/u','*',$list[$i]['wr_13'])?>
				</a>
			</td>
			<td class="td_date">
