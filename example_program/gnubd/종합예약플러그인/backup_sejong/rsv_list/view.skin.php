...
if($_POST['wr_13'] && $_POST['wr_12'] && $_POST['wr_3']){
	$sql = "update  ".$write_table." set wr_3 = '".$_POST['wr_3']."', wr_12 = '".$_POST['wr_12']."' , wr_13 = '".$_POST['wr_13']."', wr_14 = NOW() where wr_id = '".$view['wr_id']."'";
	sql_query($sql);
		...
		<form method="post" action="./board.php?bo_table=<?=$bo_table?>&wr_id=<?=$wr_id?>">
			<table class="U_table01" style="margin-bottom:10px">
				<tbody>
					...
					<tr>
						<td>아이출생년도</td>
						<td><input type="text" class="U_input01" value="<?=$view['wr_12']?>" name="wr_12" /></td>
					</tr>
					<tr>
						<td>예약자</td>
						<td><input type="text" class="U_input01" value="<?=$view['wr_13']?>" name="wr_13" /></td>
					</tr>
