			...
			<tr class="U_tr01">
				<td colspan="2">
					<table class="U_table01">
						...
						<tr>
							<td><label for="wr_12">아이생년일</label></td>
							<td><input type="text" class="U_input01 required" name="wr_12" id="wr_12"/> 예시) 2001031
								<p class="U_info01">주민번호 앞자리 6자리와 뒷자리 첫번째를 입력해주세요.</p>
							</td>
						</tr>
						
						<tr>
							<td><label for="wr_13">예약자</label></td>
							<td><input type="text" value="<? echo $wr_3 ? $wr_3 : $member['mb_name'] ?>" class="U_input01 required" name="wr_13" id="wr_13"/></td>
						</tr>
