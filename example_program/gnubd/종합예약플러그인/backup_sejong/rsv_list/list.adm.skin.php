...
<div style="margin-top:10px">
	...
	<?}?>
	<button type="button" style="float:right" class="U_btn01 TM_ds_block U_ft_ct" data-toggle="modal" data-target="#exampleModal">
	  관리설정
	</button>

	<a href="http://sejongsm.dgweb.kr/community/Reservation01" target="_blank" class="U_btn01 TM_ds_block U_ft_ct" >이전예약확인 바로가기</a>
			...
			<ul class="U_tab_con">
				<li>
					...
					<div class="TM_ds_inbl">
						...
						<input type="text" id="lbo_table" name="lbo_table" readonly value="<?=$board['bo_1']?>" class="required frm_input frm_input2"/>
					</div>

					<div class="TM_ds_inbl">
						<label for="hd_table" class="U_tit" >휴일연동게시판</label>
						<input type="text" id="hd_table" name="hd_table" readonly value="<?=$board['bo_4']?>" class="frm_input frm_input2" placeholder="연동시 휴일이 연동됩니다."/>
					</div>
					<?}else{?>
						<input type="hidden" id="lbo" name="lbo" value="1" />
					...
					<div class="TM_ds_inbl">
						...
						*/?>
						...
						//해당솔루션은 예약의 모드를 정해짐
						*/?>
						<select name="lm_moth" id="lm_moth" readonly class="frm_input frm_input2" >
							<?/*
						...
						<p style="margin-top:5px">선택한 옵션의 기준범위로 에약이 가능합니다.</p>
					</div>

					<div class="TM_ds_inbl sound_only">
					...
					<div class="TM_ds_inbl sound_only">
						...
						<p style="margin-top:5px sound_only">예약옵션에 수량,인원제어 기능</p>
					</div>
					...
					<div class="TM_ds_inbl sound_only">
						<label for="bo_use_secret sound_only" class="U_tit" >비밀글설정</label>
