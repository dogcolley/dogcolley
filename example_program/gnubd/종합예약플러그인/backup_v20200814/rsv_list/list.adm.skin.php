			...
			<ul class="U_tab_con">
				<li>
					<div class="TM_ds_inbl">
						...
						<input type="text" id="lbo_table" name="lbo_table"  <?=$member['mb_level'] ==10 ? '' : 'readonly'?> value="<?=$board['bo_1']?>" class="required frm_input frm_input2"/>
					</div>

					<div class="TM_ds_inbl">
						<label for="hd_table" class="U_tit" >휴일연동게시판</label>
						<input type="text" id="hd_table" name="hd_table"  <?=$member['mb_level'] ==10 ? '' : 'readonly'?> value="<?=$board['bo_4']?>" class="frm_input frm_input2" placeholder="연동시 휴일이 연동됩니다."/>
					</div>
					...
					<div class="TM_ds_inbl ">
						...
						<p style="margin-top:5px">당일 예약 1시간이전부터 마감됩니다.</p>
					</div>
