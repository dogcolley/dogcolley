...
<div id="bo_list<?php if ($is_admin) echo "_admin"; ?>">
    ...
    <div class="bo_fx">
        ...
        <fieldset id="bo_sch">
            ...
            <select name="sfl">
                <option value="wr_subject"<?php echo get_selected($sfl, 'wr_subject', true); ?>>휴일명</option>
				<?/*
    ...
    <div class="tbl_head01 tbl_wrap">
        ...
        <tr>
            ...
            <th scope="col" style="width:530px;">휴일명</th>
            <th scope="col" style="width:100px;">휴일날짜</th>
        ...
        <tr class="<?php if ($list[$i]['is_notice']) echo "bo_notice"; ?>">
            ...
            <td class="td_date"><?php echo $list[$i]['wr_1'];//echo substr($list[$i]['wr_datetime'],0,10) ?></td>
        </tr>
        <?php } ?>
        <?php if (count($list) == 0) { echo '<tr><td colspan="'.$colspan.'" class="empty_table">등록된 휴일이 없습니다.</td></tr>'; } ?>
        </tbody>
        </table>
    </div>
    ...
    <div class="bo_fx">
        <?php if ($rss_href || $write_href) { ?>
            <ul class="btn_bo_user">
                ...
                <?php if ($write_href) { ?><li clss="write_btn"><a href="<?php echo $write_href ?>" class="btn_b02" style="width:auto;">휴일 및 공지 등록</a></li><?php } ?>
            </ul>
         <?php } ?>
...
<script>
	$(function(){
		$('#add_auto_hd').on('click',function(){
			if(confirm('올해 공휴일을 휴일로 추가하겠습니까?\n추가시 해당 일의 예약을 모두 휴일처리 됩니다.')) return true;
			else return false;
