...
<div class="tbl_frm01 tbl_wrap">
	...
	<tr>
        <th scope="row"><label for="mb_level">회원등급<strong class="sound_only">필수</strong></label></th>
        <td colspan="3">
			<select name="mb_level" id="mb_level">
				<option value="1">비회원</option>
				<option value="2"<?php echo get_selected($mb['mb_level'], "2"); ?>>새내기</option>
				<option value="3"<?php echo get_selected($mb['mb_level'], "3"); ?>>골드</option>
				<option value="4"<?php echo get_selected($mb['mb_level'], "4"); ?>>VIP</option>
			</select>
		</td>
	</tr>
    <tr>
