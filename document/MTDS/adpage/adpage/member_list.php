...
<div class="btn_add01 btn_add">
	...
	<a href="./member_excel.php" id="member_add">엑셀다운로드</a>
</div>
<?php } ?>
...
<div class="tbl_head02 tbl_wrap">
    ...
    <tr>
		...
		<th scope="col" id="mb_list_auth">회원등급</th>
        <th scope="col" id="mb_list_lastcall"><?php echo subject_sort_link('mb_today_login', '', 'desc') ?>최종접속</a></th>
		<th scope="col" id="mb_list_join"><?php echo subject_sort_link('mb_datetime', '', 'desc') ?>가입일</a></th>
        <th scope="col" id="mb_list_grp"><?php echo subject_sort_link('mb_intercept_date', '', 'desc') ?>접근<br>차단</a></th>
    ...
    <tr class="<?php echo $bg; ?>">
		...
		<td headers="mb_list_auth" class="td_mbstat">
			<select name="mb_level[<?php echo $i ?>]">
				<option value="1">비회원</option>
				<option value="2"<?php echo get_selected($row['mb_level'], "2"); ?>>새내기</option>
				<option value="3"<?php echo get_selected($row['mb_level'], "3"); ?>>골드</option>
				<option value="4"<?php echo get_selected($row['mb_level'], "4"); ?>>VIP</option>
			</select>
		</td>
