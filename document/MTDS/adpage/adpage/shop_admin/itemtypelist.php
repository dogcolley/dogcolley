...
<div class="tbl_head01 tbl_wrap">
    ...
    <tr>
        ...
        <th scope="col"><?php echo subject_sort_link("it_type1", $qstr, 1); ?>HOT<br>상품</a></th>
		<th scope="col"><?php echo subject_sort_link("it_type4", $qstr, 1); ?>BEST<br>상품</a></th>
		<?/*
		...
		*/?>
		<th scope="col"><?php echo subject_sort_link("it_type6", $qstr, 1); ?>메인<br>상품</a></th>
        <th scope="col"><?php echo subject_sort_link("it_type7", $qstr, 1); ?>세트<br>상품</a></th>
        <th scope="col"><?php echo subject_sort_link("it_type8", $qstr, 1); ?>특가<br>상품</a></th>
        <th scope="col">관리</th>
    </tr>
    </thead>
    <tbody>
