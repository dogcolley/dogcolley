...
//<li><a href="#anc_sitfrm_skin">스킨설정</a></li><li><a href="#anc_sitfrm_extra">여분필드</a></li><li><a href="#anc_sitfrm_event">관련이벤트</a></li><li><a href="#anc_sitfrm_optional">상세설명설정</a></li>
...
if(!sql_query(" select it_type6 from {$g5['g5_shop_item_table']} limit 1", false)) {
    sql_query(" ALTER TABLE `{$g5['g5_shop_item_table']}`
                    ADD `it_type6` tinyint(4) NOT NULL DEFAULT '0' AFTER `it_use` ", true);
}

if(!sql_query(" select it_type7 from {$g5['g5_shop_item_table']} limit 1", false)) {
    sql_query(" ALTER TABLE `{$g5['g5_shop_item_table']}`
                    ADD `it_type7` tinyint(4) NOT NULL DEFAULT '0' AFTER `it_use` ", true);
}

if(!sql_query(" select it_type8 from {$g5['g5_shop_item_table']} limit 1", false)) {
    sql_query(" ALTER TABLE `{$g5['g5_shop_item_table']}`
                    ADD `it_type8` tinyint(4) NOT NULL DEFAULT '0' AFTER `it_use` ", true);
}
    ...
    <div class="tbl_frm01 tbl_wrap">
        ...
        <tr>
            ...
            <td colspan="2">
                ...
                <?php } else { ?>
                    ...
                    <a href="<?php echo G5_USER_ADMIN_URL; ?>/shop_admin/itemuselist.php?sfl=a.it_id&amp;stx=<?php echo $it_id; ?>" class="btn_frmline">사용후기</a>
                    <a href="<?php echo G5_USER_ADMIN_URL; ?>/shop_admin/itemqalist.php?sfl=a.it_id&amp;stx=<?php echo $it_id; ?>" class="btn_frmline">상품문의</a>
                <?php } ?>
            </td>
        </tr>
        <tr>
        ...
        <tr>
            ...
            <td>
                ...
                <label for="it_type1">HOT ITEM <?/*<img src="<?php echo G5_SHOP_URL; ?>/img/icon_hit.gif" alt="">*/?></label>
				<input type="checkbox" name="it_type4" value="1" <?php echo ($it['it_type4'] ? "checked" : ""); ?> id="it_type4">
                <label for="it_type4">BEST ITEM <?/*<img src="<?php echo G5_SHOP_URL; ?>/img/icon_best.gif" alt="">*/?></label>
...
<section id="anc_sitfrm_compact">
    ...
    <div id="sit_compact_fields"><?php include_once(G5_USER_ADMIN_PATH.'/shop_admin/iteminfo.php'); ?></div>
</section>
...
$(function(){
    $(document).on("change", "#it_info_gubun", function() {
        var gubun = $(this).val();
        $.post(
            "<?php echo G5_USER_ADMIN_URL; ?>/shop_admin/iteminfo.php",
            ...
            <td colspan="2">
                ...
                $(function() {
                    ...
                    $("#option_table_create").click(function() {
                        ...
                        $.post(
                            "<?php echo G5_USER_ADMIN_URL; ?>/shop_admin/itemoption.php",
            ...
            <td colspan="2">
                ...
                $(function() {
                    ...
                    $("#supply_table_create").click(function() {
                        ...
                        $.post(
                            "<?php echo G5_USER_ADMIN_URL; ?>/shop_admin/itemsupply.php",
