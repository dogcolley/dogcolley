...
<div class="tbl_head02 tbl_wrap">
    ...
    <tr class="<?php echo $bg; ?>">
        ...
        <td rowspan="3" class="td_num">
			...
			<input type="hidden" name="it_skin[<?php echo $i; ?>]" value="<?php echo $row['it_skin']; ?>">
			<input type="hidden" name="it_mobile_skin[<?php echo $i; ?>]" value="<?php echo $row['it_mobile_skin']; ?>">
