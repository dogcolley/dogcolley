...
<input type="hidden" name="bn_device" value="both">
<input type="hidden" name="bn_border" value="0">
    ...
    <tr>
        ...
        <td>
            ...
            <select name="bn_position" id="bn_position">
                <option value="세트" <?php echo get_selected($bn['bn_position'], '세트'); ?>>세트</option>
                <option value="특가" <?php echo get_selected($bn['bn_position'], '특가'); ?>>특가</option>
				<option value="메뉴바" <?php echo get_selected($bn['bn_position'], '메뉴바'); ?>>메뉴바</option>
        </select>
        </td>
    </tr>
    <tr>
