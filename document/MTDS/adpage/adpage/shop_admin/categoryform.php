...
<input type="hidden" name="ca_skin" value="<?php echo $ca['ca_skin']; ?>" id="ca_skin" required class="required frm_input" >
<input type="hidden" name="ca_img_width" value="<?php echo $ca['ca_img_width']; ?>" id="ca_img_width" required class="required frm_input" size="5" >
<input type="hidden" name="ca_img_height"  value="<?php echo $ca['ca_img_height']; ?>" id="ca_img_height" required class="required frm_input" size="5" >
<input type="hidden" name="ca_list_mod" size="3" value="<?php echo $ca['ca_list_mod']; ?>" id="ca_list_mod" required class="required frm_input">
<input type="hidden" name="ca_list_row" value='<?php echo $ca['ca_list_row']; ?>' id="ca_list_row" required class="required frm_input" size="3">
<input type="hidden" name="ca_mobile_skin" value="<?php echo $ca['ca_mobile_skin']; ?>" id="ca_mobile_skin" required class="required frm_input" >
<input type="hidden" name="ca_mobile_img_width" value="<?php echo $ca['ca_mobile_img_width']; ?>" id="ca_mobile_img_width" required class="required frm_input" size="5" >
<input type="hidden" name="ca_mobile_img_height"  value="<?php echo $ca['ca_mobile_img_height']; ?>" id="ca_mobile_img_height" required class="required frm_input" size="5" >
<input type="hidden" name="ca_mobile_list_mod" value='<?php echo $ca['ca_mobile_list_mod']; ?>' id="ca_mobile_list_mod" required class="required frm_input" size="3"> 
<input type="hidden" name="ca_mobile_list_row" value='<?php echo $ca['ca_mobile_list_row']; ?>' id="ca_mobile_list_row" required class="required frm_input" size="3">
<input type="hidden" name="ca_skin_dir" value="<?php echo $ca['ca_skin_dir']; ?>">
<input type="hidden" name="ca_mobile_skin_dir" value="<?php echo $ca['ca_mobile_skin_dir']; ?>">
...
<?php echo $frm_submit;//preg_replace('#</div>$#i', '<button type="button" class="shop_category">테마설정 가져오기</button></div>', $frm_submit); ?>
