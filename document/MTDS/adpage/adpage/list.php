...
if ($board['bo_use_category']) {
    $is_category = true;
    $category_href = G5_USER_ADMIN_URL.'/board.php?bo_table='.$bo_table;
...
// 분류 선택 또는 검색어가 있다면
$stx = trim($stx);
if ($sca || $stx || $dep1 || $dep2) {
    $sql_search = get_sql_search($sca, $sfl, $stx, $sop);

	if($sql_search=="0"){ $sql_search = "1"; }

	if($dep1){ $sql_search .= " and wr_1 = '$dep1' "; }
	if($dep2){ $sql_search .= " and wr_2 = '$dep2' "; }
